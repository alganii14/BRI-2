...
class PenurunanSmeRitelSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $csvPath = base_path('PENURUNAN SME RITEL.csv');
        ...
        $this->command->info('Data Penurunan SME Ritel berhasil diimport!');
    }
}
