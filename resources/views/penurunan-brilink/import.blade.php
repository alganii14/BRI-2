...
@section('title', 'Import CSV Penurunan Brilink')
@section('page-title', 'Import Data Penurunan Brilink dari CSV')
...
<div class="import-container">
    ...
    <div class="info-box">
        ...
        <ul>
            ...
            <li>Kolom CSV: Regional Office, Kode Cabang Induk, Cabang Induk, Kode Uker, Unit Kerja, CIFNO, No Rekening, YTD, Product Type, Nama Nasabah, Jenis Simpanan, Saldo Last EOM, Saldo Terupdate, Delta, PN Slot 1-8</li>
        </ul>
    </div>

    <form action="{{ route('penurunan-brilink.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
        @csrf
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('penurunan-brilink.index') }}" class="btn btn-secondary">
                ↩️ Kembali
            </a>
        </div>
    </form>
