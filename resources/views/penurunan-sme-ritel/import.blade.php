...
@section('title', 'Import CSV - Penurunan SME Ritel')
@section('page-title', 'Import CSV - Penurunan SME Ritel')
...
<div class="import-container">
    ...
    <div class="info-box">
        ...
        <form action="{{ route('penurunan-sme-ritel.import') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
            @csrf
