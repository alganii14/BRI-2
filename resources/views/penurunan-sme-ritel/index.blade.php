...
<div class="search-box">
    <form action="{{ route('penurunan-sme-ritel.index') }}" method="GET" style="display:flex;gap:10px;align-items:center;">
        ...
        @if($search || request('month') || request('year'))
            <a href="{{ route('penurunan-sme-ritel.index') }}" style="padding:10px 16px;background:#dc3545;color:white;border-radius:6px;text-decoration:none;white-space:nowrap;">Reset</a>
        @endif
    </form>
</div>
