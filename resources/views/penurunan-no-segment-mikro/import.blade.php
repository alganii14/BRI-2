...
@section('title', 'Import CSV Penurunan No-Segment Mikro')
@section('page-title', 'Import Data Penurunan No-Segment Mikro dari CSV')
...
<div class="import-container">
    ...
    <form action="{{ route('penurunan-no-segment-mikro.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
        @csrf
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('penurunan-no-segment-mikro.index') }}" class="btn btn-secondary">
                ↩️ Kembali
            </a>
        </div>
    </form>
