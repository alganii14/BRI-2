...
@section('title', 'Tambah Penurunan No-Segment Mikro')
@section('page-title', 'Tambah Data Penurunan No-Segment Mikro')
...
<div class="form-container">
    <form action="{{ route('penurunan-no-segment-mikro.store') }}" method="POST">
        @csrf
