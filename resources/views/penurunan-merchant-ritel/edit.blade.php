...
<div class="gradient-header">
    <h1>Edit Data Penurunan Merchant Ritel</h1>
    <p>Ubah data penurunan merchant ritel yang sudah ada</p>
</div>

<div class="form-container">
    <form method="POST" action="{{ route('penurunan-merchant-ritel.update', $data->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-group @error('penurunan') error @enderror">
                ...
                <input type="text" id="penurunan" name="penurunan" value="{{ old('penurunan', $data->penurunan) }}">
