...
@section('title', 'Tambah Top 10 QRIS Per Unit')
@section('page-title', 'Tambah Data Top 10 QRIS Per Unit')
...
<div class="form-container">
    <form action="{{ route('top10-qris-per-unit.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="mainbr" name="mainbr" value="{{ old('mainbr') }}">
                @error('mainbr')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="mbdesc" name="mbdesc" value="{{ old('mbdesc') }}">
                @error('mbdesc')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="brdesc" name="brdesc" value="{{ old('brdesc') }}">
                @error('brdesc')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="pn" name="pn" value="{{ old('pn') }}">
                @error('pn')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="pn_pemrakasa" name="pn_pemrakasa" value="{{ old('pn_pemrakasa') }}">
                @error('pn_pemrakasa')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="posisi_sv_total_september" name="posisi_sv_total_september" value="{{ old('posisi_sv_total_september') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="akumulasi_trx_total" name="akumulasi_trx_total" value="{{ old('akumulasi_trx_total') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="posisi_trx_total" name="posisi_trx_total" value="{{ old('posisi_trx_total') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="ratas_saldo" name="ratas_saldo" value="{{ old('ratas_saldo') }}">
                @error('ratas_saldo')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
